...
export const zh: Messages = {
  ...
  discussionList: {
    ...
    selectRecord: '选择此记录',
    header: 'TrialBeacon · 公开记录整理清单',
    title: '医生沟通参考清单',
    subtitle: '（仅整理公开官方记录）',
    recordCount: '共整理 {n} 条记录',
    ...
    fieldPhase: '分期',
    fieldStudyType: '研究类型',
    fieldEnrollment: '目标入组',
    fieldLocations: '招募地点',
    fieldFirstPosted: '首次发布',
    fieldUpdated: '最后更新',
    fieldContact: '官方列有公开联系人',
    fieldNct: '登记编号',
    notProvided: '未提供',
    fieldLink: '原文链接',
    linkPrompt: '请访问原链接',
    footerDisclaimer:
      '本清单仅整理公开的官方记录标题与链接，不构成任何医疗建议、推荐或适合性判断。请务必与主治医生讨论，并以官方原文为准。',
    dataNotice:
    ...
    backLink: '返回记录列表',
    promptHeading: '你可能想问的问题',
    promptIntro: '仅为提问模板，只教如何提问，不提供答案。请根据自己的情况调整。',
    promptCopy: '复制提问提示',
    promptCopied: '已复制',
    promptLines: [
      '这些记录目前还在开放招募吗？',
      '从公开信息看，它们与我的诊断、分期或既往治疗是否有字面相关？',
      '每项研究具体要做什么检查或操作，频率如何？',
      '哪些费用由研究承担，哪些需要自理？',
      '与我当前治疗相比，可能的风险和副作用是什么？',
      '我是否可以随时退出研究，退出后对我的常规治疗有什么影响？',
      '如果想去了解入组，应该联系谁、通过什么方式？',
      '是否有足够近的研究中心，让我能定期前往？',
    ],
  },
  cancers: {

...
export const zh: Messages = {
  ...
  home: {
    ...
    title2: '',
    subtitle: 'TrialBeacon 收录美国、欧洲、中国公开登记的临床试验、指南索引与监管通告，范围覆盖晚期、转移、复发、后线以及支持／姑息治疗，每一条都附官方原文链接。',
    subtitleShort: '来自美国、欧洲、中国的公开记录，覆盖晚期、转移、复发、后线与支持／姑息治疗，每条均可直达官方原文。',
    subtitleNo: '没有推荐，没有排序，没有解读。',
    heroCta: '查看 After Conservative / Palliative Care 视图',
    heroCtaShort: '打开 After Care 视图',
    heroCtaSecondary: '按癌种浏览',
    ...
    afterCareBody: '只收录官方条目本身写明晚期、转移、复发、难治、后线或支持／姑息治疗的记录。',
    afterCareNotRec: '它不是建议，也不会为任何个人挑选试验。',
    afterCareCta: '打开这个视图',
  ...
  afterCare: {
    ...
    introDesktop: '这个视图只收录官方条目本身提到晚期、转移、复发、难治、后线或支持／姑息治疗的记录。它只为一件事存在：如果您被告知考虑保守或姑息治疗，却仍想看看公开登记里到底有什么，可以在这里安静地、集中地扫读一遍，并且始终通过官方原文核对。',
    introMobile: '只收录官方条目本身提到晚期、转移、复发、难治、后线或支持／姑息治疗的记录——供被告知考虑保守或姑息治疗、仍想看看公开登记内容的人使用。',
    pleaseRead: '请先阅读以下说明。',

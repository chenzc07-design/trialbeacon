...
export const de: Messages = {
  ...
  home: {
    ...
    title2: '',
    subtitle: 'TrialBeacon indexiert öffentlich gelistete Studienregistrierungen, Leitlinien-Indizes und regulatorische Mitteilungen aus den USA, Europa und China zu fortgeschrittenen, metastasierten, rezidivierten, späteren Therapielinien sowie unterstützender / palliativer Behandlung — jeder Eintrag verlinkt direkt auf die Originalseite.',
    subtitleShort: 'Öffentliche Einträge aus den USA, Europa und China zu fortgeschrittenen, metastasierten, rezidivierten, späteren Linien sowie unterstützender / palliativer Behandlung — jeder Eintrag verlinkt auf die Originalseite.',
    subtitleNo: 'Keine Empfehlungen. Keine Rangfolge. Keine Auslegung.',
    heroCta: 'Ansicht „After Conservative / Palliative Care“ öffnen',
    heroCtaShort: 'After-Care-Ansicht öffnen',
    heroCtaSecondary: 'Nach Krebsart durchsuchen',
    ...
    afterCareBody: 'Nur offizielle Einträge, die selbst fortgeschrittene, metastasierte, rezidivierte, refraktäre, spätere Linien oder unterstützende / palliative Behandlung nennen.',
    afterCareNotRec: 'Es ist keine Beratung, und es wählt für niemanden Studien aus.',
  ...
  afterCare: {
    ...
    introDesktop: 'Diese Ansicht sammelt ausschließlich offizielle Einträge, die selbst fortgeschrittene, metastasierte, rezidivierte, refraktäre, spätere Linien oder unterstützende / palliative Behandlung erwähnen. Sie existiert aus einem einzigen Grund: Wenn Ihnen geraten wurde, konservative oder palliative Behandlung zu erwägen, Sie aber dennoch sehen möchten, was öffentlich gelistet ist, können Sie es hier in Ruhe an einem Ort überblicken — immer über die Originalquelle.',
    introMobile: 'Nur offizielle Einträge, die selbst fortgeschrittene, metastasierte, rezidivierte, refraktäre, spätere Linien oder unterstützende / palliative Behandlung nennen — für Menschen, denen konservative oder palliative Behandlung nahegelegt wurde und die dennoch sehen möchten, was öffentlich gelistet ist.',

...
export const de: Messages = {
  ...
  home: {
    ...
    subtitleShort: 'Es bündelt öffentlich zugängliche offizielle Datensätze zu fortgeschrittenen / rezidivierten / Spätlinien-Erkrankungen aus den USA, Europa und China mit direkten Links zu den Originalen.',
    subtitleNo: '',
  ...
  account: {
    ...
    orderTitle: 'Letzter Export',
    orderNone: 'Noch keine Exporte.',
    orderSingle: 'Einzelexport',
    orderSubscription: 'Pro-Abonnement',
    orderAmount: 'Betrag',
    orderDate: 'Datum',
    orderTxn: 'PayPal-Transaktion',
  ...
  following: {
    title: 'Meine Folgen',
    intro:
      'Öffentliche offizielle Datensätze, denen Sie folgen. Für Ihren nächsten Termin geordnet — ohne Empfehlung oder Interpretation.',
    recordsTitle: 'Gefolgte Datensätze',
    recordsEmpty: 'Sie haben noch keine Datensätze gespeichert.',
    recordsEmptyCta: 'Krebsarten durchsuchen',
    cancersTitle: 'Gefolgte Krebsarten',
    cancersEmpty: 'Sie folgen noch keiner Krebsart.',
    unfollow: 'Nicht mehr folgen',
    generatePdf: 'Diskussionsliste als PDF erstellen',
    generating: 'Wird erstellt…',
    digestTitle: 'Wöchentliche Zusammenfassung per E-Mail',
    digestBody:
      'Eine kurze E-Mail mit Änderungen an öffentlichen Datensätzen der Krebsarten, denen Sie folgen. Optional und nur mit Pro verfügbar.',
    digestOn: 'Wöchentliche Zusammenfassung aktiviert',
    digestOff: 'Wöchentliche Zusammenfassung deaktiviert',
    digestToggle: 'Wöchentliche Zusammenfassung der Änderungen erhalten',
    digestProOnly: 'Die wöchentliche Zusammenfassung ist eine Pro-Funktion. Upgraden Sie, um sie zu erhalten.',
    digestSaved: 'Einstellung für die Zusammenfassung gespeichert.',
    sendTest: 'Test-E-Mail senden',
    sendingTest: 'Wird gesendet…',
    testSent: 'Test-E-Mail gesendet — prüfen Sie Ihren Posteingang und Spam-Ordner.',
    testError: 'Die Test-E-Mail konnte nicht gesendet werden. Bitte versuchen Sie es erneut.',
    testNoFollows: 'Folgen Sie mindestens einem Datensatz oder einer Krebsart, um die Zusammenfassung zu erhalten.',
    testNotConfigured: 'Der E-Mail-Versand ist auf dieser Website noch nicht eingerichtet.',
    openFollowing: 'Meine Folgen öffnen',
    openAfterCare: 'Nachsorge öffnen',
    disclaimer:
      'Diese Seite ordnet ausschließlich öffentliche offizielle Datensätze. Sie ist keine medizinische Beratung, Empfehlung oder auf Ihre Situation zugeschnittene Vermittlung.',
  },
  digest: {
    subjectPrefix: 'Ihr wöchentliches TrialBeacon-Update',
    topics: 'Ihre gefolgten Themen: {topics}',
    intro: 'Zusammenfassung der öffentlichen offiziellen Datensätze, denen Sie folgen. Keine Empfehlungen, keine Interpretation.',
    recordUpdates: 'Änderungen an Datensätzen',
    recordUpdatesHint: 'Änderungen an von Ihnen gespeicherten Datensätzen:',
    cancerActivity: 'Aktivität nach Krebsart',
    cancerActivityHint: 'Neue oder aktualisierte öffentliche Datensätze in dieser Woche:',
    openFollow: 'Meine Folgen öffnen',
    generateList: 'Diskussionsliste erstellen',
    footerNote: 'Diese E-Mail ordnet ausschließlich öffentliche offizielle Datensätze. Sie ist keine medizinische Beratung, Empfehlung oder auf Ihre Situation zugeschnittene Vermittlung. Maßgeblich sind immer die offizielle Originalseite und Ihr Arzt.',
    unsubscribe: 'Abbestellen',
    noChanges: 'Diese Woche gibt es keine neuen Änderungen an öffentlichen Datensätzen in Ihren Folgen.',
    viewedOn: 'Viewed on',
  },
  changes: {
  ...
  export: {
    limitTitle: 'Kostenloses Limit erreicht ({n} Datensätze).',
    limitBody: 'Erstellen Sie für Ihren Termin eine druckfertige Diskussionsliste — nur offizielle Titel und Quellenlinks.',
    buySingle: 'Diese Liste exportieren — {price}',
    seePro: 'Pro ansehen — {price}/Monat',
    finePrint: 'Nur offizielle Titel und Links. Keine Empfehlungen, keine medizinische Beratung.',
    billedViaPaypal: 'Abgerechnet über PayPal.',
    payTitle: 'Zahlung mit PayPal abschließen',
    back: 'Zurück',
    ready: 'Ihr Export ist bereit',
    readyNote: 'Eine druckfertige PDF-Datei der ausgewählten Datensätze wurde heruntergeladen. Sie können sie unten jederzeit erneut herunterladen.',
    regenerate: 'Download erneut erstellen',
    guestSave: 'Anmelden, um Ihre Datensätze zu speichern',
    collapsedHint: 'Kostenloses Limit erreicht ({n} Datensätze).',
    seeProShort: 'Pro ansehen',
    expand: 'Exportoptionen',
    dismiss: 'Schließen',
    downloadFailed: 'Die PDF konnte nicht erstellt werden. Bitte versuchen Sie es erneut oder kontaktieren Sie',
    payFailed: 'Payment could not be completed. No charge was made — you can try again.',
  },

  research: {
    nav: 'Forschungsanalyse',
    eyebrow: 'Forschungsindex',
    title: 'Gezielte Therapien und Immuntherapie',
    intro: 'Ein nachvollziehbarer Index derzeit rekrutierender Projekte aus offiziellen öffentlichen Registern. Nach Krebsart, Studienphase und Therapieart filtern und den Originaleintrag öffnen.',
    candidatesTitle: 'Kandidatenprojekte',
    candidatesCount: '{n} Kandidatenprojekte',
    targetedOnly: 'Nur zielgerichtete Therapie',
    immunotherapyOnly: 'Nur Immuntherapie',
    bothModalities: 'Beide Therapiearten',
    filters: 'Filter',
    cancerFilter: 'Krebsart',
    phaseFilter: 'Studienphase',
    modalityFilter: 'Therapieart',
    all: 'Alle',
    allCancers: 'Alle Krebsarten',
    allPhases: 'Alle Phasen',
    allModalities: 'Alle Therapiearten',
    targeted: 'Zielgerichtete Therapie',
    immunotherapy: 'Immuntherapie',
    noMatches: 'Keine Kandidaten entsprechen diesen Filtern.',
    phaseMatrixTitle: 'Krebsart × Studienphase',
    phaseMatrixCaption: 'Gezählt werden Projektzuordnungen. Projekte mit mehreren Krebsarten erscheinen in jeder entsprechenden Zeile.',
    officialSource: 'Offizieller Registereintrag',
    evidence: 'Gefundene Hinweise',
    studyPhase: 'Studienphase',
    status: 'Rekrutierungsstatus',
    sponsor: 'Sponsor',
    viewRegistry: 'Offiziellen Eintrag öffnen',
    indexDisclaimer: 'Nur Forschungsindex. Die Stichwortsuche ist keine Behandlungsempfehlung und belegt weder Wirksamkeit, Sicherheit noch Eignung. Alle Angaben im offiziellen Register prüfen.',
    phaseLabels: {
      earlyPhase1: 'Frühe Phase 1',
      phase1: 'Phase 1',
      phase1_2: 'Phase 1/2',
      phase2: 'Phase 2',
      phase2_3: 'Phase 2/3',
  ...
  pricing: {
    ...
    faqTitle: 'Fragen',
    faqRefundQ: 'Kann ich eine Rückerstattung erhalten?',
    faqRefundA: 'Einzelexporte werden sofort als Download bereitgestellt und sind daher nicht erstattungsfähig. Beim Monatsplan können Sie jederzeit kündigen; Ihr Pro-Zugang bleibt bis zum Ende des aktuellen Zeitraums bestehen und es wird keine weitere Zahlung abgebucht.',
    faqMedicalQ: 'Ist das eine medizinische Beratung?',
    faqMedicalA: 'Nein. TrialBeacon ordnet nur öffentliche offizielle Datensätze in einer Liste. Es empfiehlt, bewertet oder interpretiert nichts.',
    faqCancelQ: 'Wie kündige ich das Abonnement?',
    faqCancelA: 'Kündigen Sie auf Ihrer Kontoseite oder direkt in PayPal. Die Kündigung beendet zukünftige Verlängerungen; der Pro-Zugang bleibt bis zum Ende des Zeitraums bestehen.',
    chinaNote:

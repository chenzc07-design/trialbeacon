...
export const de: Messages = {
  ...
  discussionList: {
    ...
    fieldStatus: 'Status',
    fieldPhase: 'Phase',
    fieldStudyType: 'Studientyp',
    fieldEnrollment: 'Zielteilnehmerzahl',
    fieldLocations: 'Rekrutierungsorte',
    fieldFirstPosted: 'Erstmals veröffentlicht',
    fieldUpdated: 'Zuletzt aktualisiert',
    fieldContact: 'Öffentlicher Kontakt angegeben',
    fieldNct: 'Identifikator',
    ...
    promptLines: [
      'Nehmen diese Studien noch Teilnehmer auf?',
      'Haben sie nach den öffentlichen Informationen einen wörtlichen Bezug zu meiner Diagnose, meinem Stadium oder meinen vorherigen Behandlungen?',
      'Welche Untersuchungen oder Eingriffe beinhaltet jede Studie und wie oft?',
      'Welche Kosten übernimmt die Studie und welche nicht?',
      'Was sind die möglichen Risiken und Nebenwirkungen im Vergleich zu meiner aktuellen Behandlung?',
      'Kann ich die Studie jederzeit verlassen, und was passiert dann?',
      'Wenn ich mehr erfahren möchte, wen sollte ich kontaktieren und wie?',
      'Gibt es eine Studienstelle, die ich regelmäßig erreichen kann?',
    ],
  },
  cancers: {
    lung: {

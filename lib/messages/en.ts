...
export const en = {
  ...
  follow: {
    ...
    limitPick: 'Choose one to drop:',
    limitReplace: 'Replace selected & follow {name}',
  ...
  // the optional weekly digest toggle. Neutral, organising-only framing.
  // ---------------------------------------------------------------------------
  following: {
    title: 'Following',
    intro:
  ...
  // ---------------------------------------------------------------------------
  // Weekly digest email (rendered in the recipient's language; en + zh).
  // ---------------------------------------------------------------------------
  digest: {
  ...
  research: {
    ...
    title: 'Targeted and immunotherapy research',
    intro: 'A traceable index of currently recruiting projects identified from official public records. Filter by cancer type, study phase and modality, then open the original registry record.',
    candidatesTitle: 'Candidate projects',
    candidatesCount: '{n} candidate projects',
    targetedOnly: 'Targeted only',
    immunotherapyOnly: 'Immunotherapy only',
    bothModalities: 'Both modalities',
    filters: 'Filters',
    cancerFilter: 'Cancer type',
    phaseFilter: 'Study phase',
    modalityFilter: 'Modality',
    all: 'All',
    allCancers: 'All cancer types',
    allPhases: 'All phases',
    allModalities: 'All modalities',
    targeted: 'Targeted therapy',
    immunotherapy: 'Immunotherapy',
    noMatches: 'No candidate projects match these filters.',
    phaseMatrixTitle: 'Cancer type × study phase',
    phaseMatrixCaption: 'Counts are candidate assignments. A project with multiple cancer tags appears in each relevant cancer row.',
    officialSource: 'Official registry record',
    evidence: 'Matched evidence',
    studyPhase: 'Study phase',
    status: 'Recruitment status',
    sponsor: 'Sponsor',
    viewRegistry: 'View official record',
    indexDisclaimer: 'Research index only. Keyword matching is not a treatment recommendation and does not establish efficacy, safety or suitability. Verify every detail in the official registry record.',
    phaseLabels: {

    ...
    >
      <label className="relative flex-1">
        ...
        <input
          ...
          className={`w-full rounded-xl border border-slateish-300 bg-white pl-10 pr-4 text-ink-900 placeholder:text-slateish-400 focus:border-navy-400 ${
            size === 'lg' ? 'py-3.5 text-[15px]' : 'py-2.5 text-sm'
          }`}
        />
      </label>
      <button type="submit" className={size === 'lg' ? 'btn-primary px-5' : 'btn-primary'}>
